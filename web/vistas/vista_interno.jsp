<%-- 
  Descripcion       : Formulario  de interno
  Creado por        : Quichua
            ...
            <form role="form">
                ...
                <div class="row">  
                    ...
                    <div class="col-lg-3">
                        <label>FechaInicio</label> 
                        <div class="input-group">
                            <input class="form-control date-picker" id="txtFechaTernino" type="text" data-date-format="dd/mm/yyyy" placeholder="FechaInicio" obligatorio UpperCase/>
                            <span class="input-group-addon">
                                <i class="fa fa-calendar bigger-110"></i>
                            </span>
                        </div>
                    ...
                    <div class="col-lg-3"> 
                        ...
                        <input id="txtTipoPago" class="form-control" placeholder="TipoPago" obligatorio UpperCase> 
                    </div> 
                </div> 
                <br> 
